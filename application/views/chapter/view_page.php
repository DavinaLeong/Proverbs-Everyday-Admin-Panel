    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li class="active">Chapter ID: <?=$chapter['chapter_id'];?></li>
            </ol>

            <div id="content-wrapper" class="row">
                <div class="col-lg-12">

                    <h1 class="page-header">View Chapter&nbsp;
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?=site_url('chapter/edit_chapter/' . $chapter['chapter_id']);?>"><i class="fa fa-pencil-square-o fa-fw"></i> Edit</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-11">
                            ...
                            <form id="view_chapter_form" class="form-horizontal">
                                <fieldset>
                                    <legend>Info</legend>

                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Chapter No</label>
                                        <div class="col-md-10">
                                            <p id="chapter_no" class="form-control-static"><?=$chapter['chapter_no'];?></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Total Verses</label>
                                        <div class="col-md-10">
                                            <p id="total_verses" class="form-control-static"><?=$chapter['total_verses'];?></p>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <p class="form-control-static status-<?=strtolower($chapter['status']);?>" id="status"><?=$chapter['status'];?></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
