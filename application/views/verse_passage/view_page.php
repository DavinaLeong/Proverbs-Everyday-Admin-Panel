                            ...
                            <form id="view_verse_passage_form" class="form-horizontal">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <p id="name" class="form-control-static"><?=$verse_passage['verse_no'];?></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Chapter</label>
                                        <div class="col-md-10">
                                            <p id="abbr" class="form-control-static"><?=$verse_passage['chapter_no'];?></p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Verse Passage</label>
                                        <div class="col-md-10">
                                            <p id="abbr" class="form-control-static"><?=$verse_passage['name'];?> (<?=$verse_passage['abbr'];?>)</p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <div class="well well-sm" style="background: #fff">
                                                <p id="copyright"><?=nl2br($verse_passage['passage']);?></p>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
