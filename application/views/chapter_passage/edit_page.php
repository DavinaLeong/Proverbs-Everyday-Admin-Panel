    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <ol class="breadcrumb">
                ...
                <li><a href="<?=site_url('chapter_passage/view_chapter_passage/' . $chapter_passage['cp_id']);?>">Chapter Passage ID: <?=$chapter_passage['cp_id'];?></a></li>
                <li class="active">Edit Chapter Passage</li>
            </ol>

            <div id="content-wrapper" class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Chapter Passage</h1>
                            ...
                            <form id="new_translation_form" class="form-horizontal" method="post" data-parsley-validate>
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" rows="4" id="passage" name="passage" required data-parsley-errors-container="#passage_errors"><?=set_value('passage', $chapter_passage['passage']);?></textarea>
                                            <script>
